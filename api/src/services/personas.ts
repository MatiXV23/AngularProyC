...
// AGREGUE PASS como contrasenia xq no tengo la enie y me canse de hacer copy a esta Xd
export const authPerson = async function (
  username: string,
  password: string
): Promise<Persona> {
  if (password !== "contraseña" && password !== "pass") throw new UcuDatosIncorrectos("");
